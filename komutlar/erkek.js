...
exports.run = async (client, message, args) => {//splashen
    ...
    let PİERREBELLEC = ayarlar.PİERREBELLEC 
...
message.guild.members.cache.get(kullanıcı.id).roles.add(PİERREBELLEC)
